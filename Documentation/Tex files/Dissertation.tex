...
\centerline{
	...
	\subsection{Data Analyses}
		...
		with the exception of the final question, ``How likely are you to engage with course-related material on this platform", which came in at a very close second. Figure 5 displays the mean scores
